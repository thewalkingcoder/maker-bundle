...
use Twc\MakerBundle\Doctrine\EntityClassGenerator;
use Twc\MakerBundle\Support;
/**
 * @author wrapper thewalkingcoder
 * @author Javier Eguiluz <javier.eguiluz@gmail.com>
 * @author Ryan Weaver <weaverryan@gmail.com>
 * @author Kévin Dunglas <dunglas@gmail.com>
 */
final class MakeTwcEntity extends AbstractMaker implements InputAwareMakerInterface
{
    use UidTrait;
    ...
    public function configureCommand(Command $command, InputConfiguration $inputConfig): void
    {
        ...
        ->setHelp('/../Resources/help/MakeEntity.txt')
        ;
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $namespaceEntityContext = $this->contextGenerator->classNameByContext(
            Support::ENTITY,
            $name,
            $context,
            'target_entity'
        ...
        if (!$classExists) {
            ...
            $namespaceRepositoryContext = ltrim($namespaceRepositoryContext, '\\');
            ...
            $entityPath = $this->entityClassGenerator->generateEntityClass(
                ...
                generateRepositoryClass: $namespaceRepositoryContext
            );
